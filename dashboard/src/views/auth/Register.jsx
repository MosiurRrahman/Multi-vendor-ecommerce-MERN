    ...
    <div className="min-w-screen min-h-screen bg-[#161d31] flex justify-center items-center">
      <div className="w-[350px] text-[#d0d2d6] p-2">
        <div className="bg-[#283046] py-5 px-3 rounded hover:rounded-lg">
          <h2 className="text-xl mb-3">Welcome to e-commarce</h2>
          ...
          <form onSubmit={submit}>
            ...
            <div className="flex items-center  w-full gap-3 mb-3">
              <input
                className="w-4 h-4 text-blue-600  bg-gray-100 rounded border-gray-300 overflow-hidden"
                type="checkbox"
                name="checkbox"
                id="checkbox"
              />
              <label>I agree to privacy and trams</label>
            </div>
            <button className="bg-blue-500 w-full hover:shadow-blue-500/50 hover:shadow-lg text-white- rounded-md px-7 py-2 md-3">
              Sign Up
            </button>
