        ...
        <div className='px-2 lg:px-7 pt-5'>
            ...
            <div className="flex flex-wrap w-full">
                <div className="w-full lg:w-7/12">
                    <div className="w-full p-4 bg-[#283046] rounded-sm">
                                ...
                                <tbody>
                                    {
                                        [1, 2, 3, 4, 5].map((d, i) => <tr key={i}>
                                            ...
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><img className='w-[45px] h-[46px]' src={`/images/category/${d}.jpg`} alt="" /></td>
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                                                <span>Sports</span>
                                            </td>
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                                                <div className="flex justify-start items-center gap-4">
                                                    <Link className='p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shadow-yellow-500/5'><FaEdit /></Link>
                                                    <Link className='p-[6px] bg-red-500 rounded hover:shadow-lg hover:shadow-yellow-500/5'><FaTrash /></Link>
                                                </div>
                                            </td>
                                        </tr>)
                                    }
                    ...
                    <div className='bg-[#283046] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]'>
                            ...
                            <form action="">
                                <div className='flex flex-col w-full gap-1 mb-3'>
                                    ...
                                    <input className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]' type="text" id='name' name='category_name' placeholder='category name' required />
                                </div>
                                <div>
